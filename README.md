...
Le mode de démonstration (`DEMO_MODE=true`) affiche uniquement des données fictives et contourne l’authentification pour le développement local. Il ne doit jamais être activé en production.
