...
function ReportsView({ data, filters, error, canReview, canWrite, canReadAll }: { data: Awaited<ReturnType<typeof getReports>>; filters: ReportFilters; error: string | null; canReview: boolean; canWrite: boolean; canReadAll: boolean }) {
  ...
  return <ModulePage eyebrow="Suivi des agents" title={canReadAll ? "Historique des rapports" : "Mes rapports"} description={canReadAll ? "Historique complet des rapports accessibles — les brouillons privés des autres agents restent masqués." : "Consultez vos rapports et leur état de validation."}
