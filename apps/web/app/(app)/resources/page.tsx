...
export default async function ResourcesPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <ModulePage eyebrow="Catalogue et tarification" title="Ressources" description="Prix publics historisés, points et exonération gagnés par unité donnée, disponibilité du village."
