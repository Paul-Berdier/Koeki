...
type BoardSlots = Record<string, { tier: string; type: string | null }>;

/** The bot's Jonin-equipment board (09/08): authoritative grades (Jōnin / CMJ / Kage) and
 *  the freshest loadout per person — the duplicate lowercase "seisura" row is the newest.
 *  Missing profiles are created, and the current week is rebilled at the new rates with
 *  ledger-accurate refunds (only credit-funded exemptions are refunded). */
async function applyJoninBoard20260809() {
  const FLAG_BOARD = "kvJoninBoard2026-08-09";
  if (await prisma.appSetting.findUnique({ where: { key: FLAG_BOARD } })) { console.log("import-legacy/tableau-jonin : déjà appliqué"); return; }
  const BOARD: Array<{ name: string; grade: "JONIN" | "JONIN_COMMANDER" | "KAGE"; slots: BoardSlots }> = [
    { name: "Azuna Sabaku", grade: "JONIN", slots: { haut: { tier: "T3", type: "Armure" }, bas: { tier: "T3", type: "Jutsu" }, bottes: { tier: "T3", type: "Armure" }, boucles: { tier: "Aucun", type: null }, bague: { tier: "T3", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Areto Roran", grade: "JONIN", slots: { haut: { tier: "T3", type: "Jutsu" }, bas: { tier: "T3", type: "Armure" }, bottes: { tier: "T3", type: "Jutsu" }, boucles: { tier: "T3", type: null }, bague: { tier: "T2", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Araki Hoki", grade: "JONIN", slots: { haut: { tier: "T3", type: "Jutsu" }, bas: { tier: "T3", type: "Armure" }, bottes: { tier: "T3", type: "Armure" }, boucles: { tier: "Aucun", type: null }, bague: { tier: "Aucun", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Kazetsu Roran", grade: "JONIN", slots: { haut: { tier: "T3", type: "Armure" }, bas: { tier: "T3", type: "Armure" }, bottes: { tier: "T3", type: "Ténacité" }, boucles: { tier: "T3", type: null }, bague: { tier: "T3", type: null }, collier: { tier: "T2", type: null }, gants: { tier: "T2", type: null } } },
    { name: "Shiro Sajin", grade: "JONIN", slots: { haut: { tier: "T3", type: "Armure" }, bas: { tier: "T3", type: "Jutsu" }, bottes: { tier: "T3", type: "Armure" }, boucles: { tier: "T3", type: null }, bague: { tier: "T3", type: null }, collier: { tier: "T2", type: null }, gants: { tier: "T2", type: null } } },
    { name: "Shinraishi Ara", grade: "JONIN", slots: { haut: { tier: "Aucun", type: null }, bas: { tier: "T2", type: "Armure" }, bottes: { tier: "T3", type: "Ténacité" }, boucles: { tier: "Aucun", type: null }, bague: { tier: "T2", type: null }, collier: { tier: "Aucun", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Naojin Minami", grade: "JONIN", slots: { haut: { tier: "T3", type: "Armure" }, bas: { tier: "T4", type: "Armure" }, bottes: { tier: "T3", type: "Jutsu" }, boucles: { tier: "Aucun", type: null }, bague: { tier: "T3", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Keisuke Sano", grade: "JONIN", slots: { haut: { tier: "T3", type: "Armure" }, bas: { tier: "T3", type: "Armure" }, bottes: { tier: "T4", type: "Armure" }, boucles: { tier: "T3", type: null }, bague: { tier: "T2", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "T3", type: null } } },
    { name: "Seiren Chiikatsume", grade: "JONIN_COMMANDER", slots: { haut: { tier: "T4", type: "Jutsu" }, bas: { tier: "T4", type: "Armure" }, bottes: { tier: "T4", type: "Ténacité" }, boucles: { tier: "T4", type: null }, bague: { tier: "T3", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "T3", type: null } } },
    { name: "Seisura Sabaku", grade: "JONIN_COMMANDER", slots: { haut: { tier: "T4", type: "Jutsu" }, bas: { tier: "T4", type: "Armure" }, bottes: { tier: "T4", type: "Jutsu" }, boucles: { tier: "T4", type: null }, bague: { tier: "T4", type: null }, collier: { tier: "T3", type: null }, gants: { tier: "T3", type: null } } },
    { name: "Sôki Tsukihana", grade: "JONIN_COMMANDER", slots: { haut: { tier: "Aucun", type: null }, bas: { tier: "Aucun", type: null }, bottes: { tier: "Aucun", type: null }, boucles: { tier: "Aucun", type: null }, bague: { tier: "Aucun", type: null }, collier: { tier: "Aucun", type: null }, gants: { tier: "Aucun", type: null } } },
    { name: "Kenma Hakumei", grade: "KAGE", slots: { haut: { tier: "T4", type: "Armure" }, bas: { tier: "T4", type: "Armure" }, bottes: { tier: "T4", type: "Ténacité" }, boucles: { tier: "T4", type: null }, bague: { tier: "T4", type: null }, collier: { tier: "T4", type: null }, gants: { tier: "T4", type: null } } },
    { name: "Gao", grade: "JONIN", slots: { haut: { tier: "Aucun", type: null }, bas: { tier: "Aucun", type: null }, bottes: { tier: "Aucun", type: null }, boucles: { tier: "T3", type: null }, bague: { tier: "Aucun", type: null }, collier: { tier: "Aucun", type: null }, gants: { tier: "Aucun", type: null } } }
  ];
  const [gradeRows, policy, rpSetting, systemUser] = await Promise.all([
    prisma.ninjaGrade.findMany(),
    prisma.taxPolicy.findFirst({ where: { isActive: true }, include: { rates: true } }),
  ...
  if (!policy || !systemUser) { console.log("import-legacy/tableau-jonin : référentiels absents"); return; }
  const gradeByCode = new Map(gradeRows.map((grade) => [grade.code, grade]));
  const rates = new Map(policy.rates.map((rate) => [rate.gradeId, rate.amount]));
  const rp = rpSetting?.value as { realAnchorAt?: string; rpAnchorYear?: number; realMillisecondsPerRpYear?: number } | undefined;
  const anchor = Date.parse(rp?.realAnchorAt ?? "2026-01-04T23:00:00.000Z");
  ...
  const currentRpYear = (rp?.rpAnchorYear ?? 20) + Math.floor((now.getTime() - anchor) / duration);
  await prisma.$transaction(async (tx) => {
    const profiles = await tx.ninjaProfile.findMany({ select: { id: true, firstName: true, lastName: true, currentGradeId: true } });
    const profileByName = new Map(profiles.map((profile) => [normalizeName(`${profile.firstName} ${profile.lastName}`), profile]));
    let regraded = 0, created = 0, loadouts = 0;
    for (const entry of BOARD) {
      const target = gradeByCode.get(entry.grade);
      if (!target) continue;
      let profile = profileByName.get(normalizeName(entry.name));
      if (!profile) {
        const parts = entry.name.split(/\s+/);
        const fresh = await tx.ninjaProfile.create({ data: { code: `NIN-EJ${String(++created).padStart(4, "0")}`, firstName: parts[0] ?? entry.name, lastName: parts.slice(1).join(" "), currentGradeId: target.id, notes: "Créé depuis le tableau d’équipement Jonin du bot (09/08/2026)" } });
        await tx.ninjaGradeHistory.create({ data: { ninjaId: fresh.id, gradeId: target.id, effectiveFrom: now, reason: "Tableau d’équipement Jonin du bot (09/08/2026)", changedById: systemUser.id } });
        profile = { id: fresh.id, firstName: fresh.firstName, lastName: fresh.lastName, currentGradeId: target.id };
        profileByName.set(normalizeName(entry.name), profile);
      } else if (profile.currentGradeId !== target.id) {
        await tx.ninjaGradeHistory.updateMany({ where: { ninjaId: profile.id, effectiveTo: null }, data: { effectiveTo: now } });
        await tx.ninjaGradeHistory.create({ data: { ninjaId: profile.id, gradeId: target.id, effectiveFrom: now, reason: "Grade du tableau d’équipement Jonin du bot (09/08/2026)", changedById: systemUser.id } });
        await tx.ninjaProfile.update({ where: { id: profile.id }, data: { currentGradeId: target.id } });
        profile.currentGradeId = target.id;
        regraded++;
      }
      await tx.ninjaEquipment.upsert({ where: { ninjaId: profile.id }, create: { ninjaId: profile.id, slots: entry.slots, updatedById: systemUser.id }, update: { slots: entry.slots, updatedById: systemUser.id } });
      loadouts++;
    }
    // Current week: refund credit-funded exemptions on untouched lines, rebill at the new rates,
    // re-settle bot-advance payments, then cover the rest with available credit.
    let refunded = 0n, rebilled = 0, advanceSettled = 0, covered = 0;
    if (regraded > 0 || created > 0) {
      const year = await tx.taxYear.findUnique({ where: { rpYear: currentRpYear } });
      if (year) {
        const candidates = await tx.taxAssessment.findMany({ where: {
          taxYearId: year.id, taxPolicy: { name: { not: "Ancien registre" } },
        ...
        for (const assessment of candidates) {
          ...
          const funded = debits.reduce((sum, entry) => sum - entry.amount, 0n);
          if (funded > 0n) {
            await tx.exemptionLedgerEntry.create({ data: { ninjaId: assessment.ninjaId, amount: funded, sourceType: "TaxAssessmentRefund", sourceId: assessment.id, reason: "Refacturation grades Jonin du 09/08/2026 — crédit restitué" } });
            refunded += funded;
          }
          await tx.taxExemption.deleteMany({ where: { assessmentId: assessment.id } });
        }
        ...
        for (const ninja of kv.ninjas) {
          if (!ninja.taxes.some((record) => record.week === currentWeekKey && record.paid)) continue;
          const profile = profileByName.get(normalizeName(`${ninja.firstName} ${ninja.lastName}`));
          if (!profile) continue;
          const assessment = await tx.taxAssessment.findUnique({ where: { ninjaId_taxYearId: { ninjaId: profile.id, taxYearId: year.id } } });
          if (!assessment || assessment.originalAmount <= 0n || assessment.status === "PAID") continue;
          await tx.taxExemption.create({ data: { assessmentId: assessment.id, amount: assessment.originalAmount, reason: "Payée d’avance à l’ancien registre (07/08/2026)", grantedById: systemUser.id } });
    ...
    await tx.appSetting.create({ data: { key: FLAG_BOARD, value: { appliedAt: now.toISOString(), regraded, created, loadouts, refunded: String(refunded), rebilled, advanceSettled, covered } } });
    await tx.auditLog.create({ data: { action: "KV_JONIN_BOARD", entityType: "NinjaProfile", entityId: FLAG_BOARD, requestId: randomUUID(), reason: `Tableau d’équipement Jonin appliqué : ${regraded} grades corrigés (Jōnin/CMJ/Kage), ${created} fiche${created > 1 ? "s" : ""} créée${created > 1 ? "s" : ""}, ${loadouts} panoplies synchronisées — semaine refacturée (${rebilled} taxes, ${Number(refunded).toLocaleString("fr-FR")} ¥ restitués, ${advanceSettled} payées d’avance, ${covered} couvertes par crédit)` } });
    console.log(`import-legacy/tableau-jonin : ${regraded} grades, ${created} créés, ${loadouts} panoplies, ${rebilled} taxes refacturées`);
  }, { timeout: 600_000, maxWait: 30_000 });
}
